        ...
        setState(
          () {
            for (var i = 0; i < listaMenu.length; i++) {
              columns = <PlutoColumn>[
                for (int colTam = 0; colTam < listaMenu.length; colTam++) ...{
                  PlutoColumn(
                    title: '$colTam|${listaMenu[_controller.selectedIndex]}',
      ...
      if (_controller.selectedIndex == i) {
        return Table(
            ...
            children: [
              ...
              TableRow(children: [
                Column(
                    children: [Text('${teste1[_controller.selectedIndex]}')]),
                  ...
                  builder: (context, child) {
                    ...
                    return Column(
                      children: [
                        ...
                        if (_controller.selectedIndex != 0) ...{
                          Text(teste1[_controller.selectedIndex])
                        }
                      ],
                    );
                    //}
  ...
  menu(int numero) {
    try {
      for (int i = 0; i < teste1.length; i++) {
        if (teste1[_controller.selectedIndex] == teste1[i]) {
          numero = i;
          print(numero);
          return numero;
        }
